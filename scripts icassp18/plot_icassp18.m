...
% Influence of the anisotropy parameters (Fig. 2 in the paper)
load(strcat(out_path,'bag_dev.mat'))
...
% Display test results SDR and PEASS (Table 1 in the paper)
load('bag_test_sdr.mat')
bss_av = mean(score, 3);
print('BSS score --')
transpose(bss_av)
load('bag_test_peass.mat')
